                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer_widget">
                        ...
                        <div class="footer_widget_contect">
                            <p><i class="fa fa-map-marker" aria-hidden="true"></i> 99 Duy Tân, Hà Lam, Thăng Bình, Quảng Nam</p>

                            <p><i class="fa fa-mobile" aria-hidden="true"></i> 033.2222.888 - 033.2222.999 </p>
                            <a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> levantri@gmail.com </a>
                            <ul>
                                <li>Thời gian làm việc: Thứ 2 - Chủ nhật.</li>
                                <li>&nbsp; Sáng: 7h30h - 12h</li>
                                <li>&nbsp; Chiều: 13h - 22h</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="copyright_area">
                        <p>&copy; 2021 - Bản quyền thuộc về WM Fashion. </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
