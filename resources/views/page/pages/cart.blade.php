                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product_quantity">
                                                    <div><input class="min_quantity" id="qty-{{$cart['item']['id']}}" onchange="changeQuantity(this)" style="background: #fff;font-size: 18px;" min="1" type="number" value="{{$cart['qty']}}"></div><br>
                                                    
                                                </td>
                                                <td id="total-{{$cart['item']['id']}}" class="product_total">
                                                    @if($cart['item']['promotion_price']==0)
                                                ...
                                                <td class="product_remove">
                                                    <a class="btn-sm" data-url="{{route('delete_carts',$cart['item']['id'])}}"><i style="margin-top: 40%;margin-left: 30%;font-size: 25px;" class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                @endforeach
